...
export default function EcoSparkHero() {
  const slides = [
    {
      ...
      description: "Switch to sustainable solar solutions and reduce your carbon footprint while saving on energy costs.",
      ctaText: "Explore Solutions",
      ctaLink: "/solutions",
    },
    {
      image: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?q=80&w=1920",
      badge: "Sustainable Future",
      title: "Sparking an Eco-Friendly Revolution",
      description: "Join EcoSpark in creating a cleaner, greener planet through smart renewable energy technologies.",
      ctaText: "Join EcoSpark",
      ctaLink: "/register",
    },
    {
      image: "https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?q=80&w=1920",
      badge: "Smart Innovation",
      title: "Innovative Tech for Nature",
      description: "Bridge the gap between modern infrastructure and environmental preservation with smart energy grids.",
      ctaText: "Learn More",
      ctaLink: "/about",
    },
  ];
  ...
  return (
    // 'container mx-auto' ব্যবহার করা হয়েছে যাতে এটি ফুটারের সাথে পুরোপুরি এলাইন থাকে
    <div className="container mx-auto px-4 py-6 md:py-10">
      ...
      >
            ...
            <CarouselItem key={index}>
              <div className="relative h-[500px] md:h-[600px] w-full">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent flex items-center">
                  <div className="text-left text-white px-6 md:px-16 max-w-3xl">
        ...
        {/* Navigation Buttons - এখন আরও ভালো পজিশন করা */}
        <div className="hidden md:block">
          <CarouselPrevious className="absolute left-6 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-emerald-600 border-none text-white transition-all size-11" />
          <CarouselNext className="absolute right-6 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-emerald-600 border-none text-white transition-all size-11" />
        </div>
      </Carousel>
    </div>
  );
